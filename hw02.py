...
def accumulate(combiner, base, n, f):
    ...
    total, k = base, 1
    while k <= n:
        total, k = base + combiner(total, f(k)), k+1
    return total
...
def product_using_accumulate(n, f):
    ...
    True
    """
    return accumulate(mul,1,4,square)
...
def make_repeater(h, n):
    ...
    5
    """
    g = identity #identity in Python refers to the object you are referring to.
    while n > 0:
        g = compose1(h,g)
        n = n - 1
    return g
